...
void Metric_conf::compute_ricci_tensor (int dd) const {
	...
	bool doder = ((der_cov.der_t==0x0) || (der_con.der_t==0x0) || (dder_con.der_t==0x0)) ? false : true ;
			...
			cmpval += 0.5 * ((*p_met_con[dd]->val_t)(k,l)(dd)*(*dder_con.val_t)(k,l, pos(0)+1, pos(1)+1)(dd)
			 ...
			 for (int m=1 ; m<=espace.get_ndim() ; m++)
			    for (int n=1 ; n<espace.get_ndim() ; n++)
			      cmpval += 0.5 * (
	-(*p_met_cov[dd]->val_t)(k,l)(dd)*(*p_met_con[dd]->val_t)(m,n)(dd)*(*der_con.val_t)(m, pos(0)+1, k)(dd)*(*der_con.val_t)(n, pos(1)+1, l)(dd)
	+(*p_met_cov[dd]->val_t)(m,l)(dd)*(*p_met_con[dd]->val_t)(pos(0)+1,k)(dd)*(*der_con.val_t)(k, m, n)(dd)*(*der_con.val_t)(n, pos(1)+1, l)(dd)
	+(*p_met_cov[dd]->val_t)(k,n)(dd)*(*p_met_con[dd]->val_t)(pos(1)+1,l)(dd)*(*der_con.val_t)(l, m, n)(dd)*(*der_con.val_t)(m, pos(0)+1, k)(dd)
	+0.5*(*p_met_cov[dd]->val_t)(pos(0)+1,k)(dd)*(*p_met_con[dd]->val_t)(pos(1)+1,l)(dd)*(*der_cov.val_t)(k, m, n)(dd)*(*der_con.val_t)(l,m,n)(dd)) ;
		...
		for (int k=1 ; k<=espace.get_ndim() ; k++) 
			...
			+(*p_met_con[dd]->val_t)(k,l)(dd)*(*dder_con.der_t)(k,l, pos(0)+1, pos(1)+1)(dd)
			 ...
			 for (int m=1 ; m<=espace.get_ndim() ; m++)
			    for (int n=1 ; n<espace.get_ndim() ; n++)
			      cmpval += 0.5 * (
	-(*p_met_cov[dd]->der_t)(k,l)(dd)*(*p_met_con[dd]->val_t)(m,n)(dd)*(*der_con.val_t)(m, pos(0)+1, k)(dd)*(*der_con.val_t)(n, pos(1)+1, l)(dd)
	-(*p_met_cov[dd]->val_t)(k,l)(dd)*(*p_met_con[dd]->der_t)(m,n)(dd)*(*der_con.val_t)(m, pos(0)+1, k)(dd)*(*der_con.val_t)(n, pos(1)+1, l)(dd)
	-(*p_met_cov[dd]->val_t)(k,l)(dd)*(*p_met_con[dd]->val_t)(m,n)(dd)*(*der_con.der_t)(m, pos(0)+1, k)(dd)*(*der_con.val_t)(n, pos(1)+1, l)(dd)
	-(*p_met_cov[dd]->val_t)(k,l)(dd)*(*p_met_con[dd]->val_t)(m,n)(dd)*(*der_con.val_t)(m, pos(0)+1, k)(dd)*(*der_con.der_t)(n, pos(1)+1, l)(dd)
	+(*p_met_cov[dd]->der_t)(m,l)(dd)*(*p_met_con[dd]->val_t)(pos(0)+1,k)(dd)*(*der_con.val_t)(k, m, n)(dd)*(*der_con.val_t)(n, pos(1)+1, l)(dd)
	+(*p_met_cov[dd]->val_t)(m,l)(dd)*(*p_met_con[dd]->der_t)(pos(0)+1,k)(dd)*(*der_con.val_t)(k, m, n)(dd)*(*der_con.val_t)(n, pos(1)+1, l)(dd)
	+(*p_met_cov[dd]->val_t)(m,l)(dd)*(*p_met_con[dd]->val_t)(pos(0)+1,k)(dd)*(*der_con.der_t)(k, m, n)(dd)*(*der_con.val_t)(n, pos(1)+1, l)(dd)
	+(*p_met_cov[dd]->val_t)(m,l)(dd)*(*p_met_con[dd]->val_t)(pos(0)+1,k)(dd)*(*der_con.val_t)(k, m, n)(dd)*(*der_con.der_t)(n, pos(1)+1, l)(dd)
	+(*p_met_cov[dd]->der_t)(k,n)(dd)*(*p_met_con[dd]->val_t)(pos(1)+1,l)(dd)*(*der_con.val_t)(l, m, n)(dd)*(*der_con.val_t)(m, pos(0)+1, k)(dd)
	+(*p_met_cov[dd]->val_t)(k,n)(dd)*(*p_met_con[dd]->der_t)(pos(1)+1,l)(dd)*(*der_con.val_t)(l, m, n)(dd)*(*der_con.val_t)(m, pos(0)+1, k)(dd)
	+(*p_met_cov[dd]->val_t)(k,n)(dd)*(*p_met_con[dd]->val_t)(pos(1)+1,l)(dd)*(*der_con.der_t)(l, m, n)(dd)*(*der_con.val_t)(m, pos(0)+1, k)(dd)
	+(*p_met_cov[dd]->val_t)(k,n)(dd)*(*p_met_con[dd]->val_t)(pos(1)+1,l)(dd)*(*der_con.val_t)(l, m, n)(dd)*(*der_con.der_t)(m, pos(0)+1, k)(dd)
	+0.5*(*p_met_cov[dd]->der_t)(pos(0)+1,k)(dd)*(*p_met_con[dd]->val_t)(pos(1)+1,l)(dd)*(*der_cov.val_t)(k, m, n)(dd)*(*der_con.val_t)(l,m,n)(dd)
	+0.5*(*p_met_cov[dd]->val_t)(pos(0)+1,k)(dd)*(*p_met_con[dd]->der_t)(pos(1)+1,l)(dd)*(*der_cov.val_t)(k, m, n)(dd)*(*der_con.val_t)(l,m,n)(dd)
	+0.5*(*p_met_cov[dd]->val_t)(pos(0)+1,k)(dd)*(*p_met_con[dd]->val_t)(pos(1)+1,l)(dd)*(*der_cov.der_t)(k, m, n)(dd)*(*der_con.val_t)(l,m,n)(dd)
	+0.5*(*p_met_cov[dd]->val_t)(pos(0)+1,k)(dd)*(*p_met_con[dd]->val_t)(pos(1)+1,l)(dd)*(*der_cov.val_t)(k, m, n)(dd)*(*der_con.der_t)(l,m,n)(dd)
	) ;
	...
	// Dirac part 
		for (int k=1 ; k<=espace.get_ndim() ; k++)
		    cmpder += 0.5 * ((*p_dirac[dd]->der_t)(k)(dd)*(*der_con.val_t)(k, pos(0)+1, pos(1)+1)(dd)
...
void Metric_conf::compute_dirac (int dd) const {
	...
	if (!doder) {
		if (p_dirac[dd]==0x0)
			p_dirac[dd] = new Term_eq(dd, res_val) ;
		else
			*p_dirac[dd] = Term_eq (dd, res_val) ;
	}
	else {
		if (p_dirac[dd]==0x0)
			p_dirac[dd] = new Term_eq(dd, res_val, res_der) ;
		else
