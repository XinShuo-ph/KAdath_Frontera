...
ostream& operator<< (ostream& o, const Domain_polar_periodic_nucleus& so) {
...
void Domain_polar_periodic_nucleus::do_der_abs_from_der_var(const Val_domain_ptr_array &der_var, Val_domain_ptr_array &der_abs) const {
