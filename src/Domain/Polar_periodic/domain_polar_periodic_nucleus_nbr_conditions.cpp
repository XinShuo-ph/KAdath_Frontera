		...
		case 2 :
			if (tt.get_n_comp()==6) {
				if (n_cmp==-1) {
					...
					res.set(4) = nbr_conditions_val_domain (tt(2,3)(dom), 1, order) ;
					...
					if (((*p_cmp[i])(0)==2) && ((*p_cmp[i])(1)==3))
						res.set(i) = nbr_conditions_val_domain (tt(2, 3)(dom), 1, order) ;
			...
			if (tt.get_n_comp()==9) {
				if (n_cmp==-1) {
					...
					res.set(5) = nbr_conditions_val_domain (tt(2,3)(dom), 1, order) ;
					res.set(6) = nbr_conditions_val_domain (tt(3,1)(dom), 1, order) ;
					res.set(7) = nbr_conditions_val_domain (tt(3,2)(dom), 1, order) ;
					...
					if (((*p_cmp[i])(0)==3) && ((*p_cmp[i])(1)==2))
						res.set(i) = nbr_conditions_val_domain (tt(3, 2)(dom), 1, order) ;
					if (((*p_cmp[i])(0)==3) && ((*p_cmp[i])(1)==3))
						res.set(i) = nbr_conditions_val_domain (tt(3, 3)(dom), 0, order) ;
				}
			}
