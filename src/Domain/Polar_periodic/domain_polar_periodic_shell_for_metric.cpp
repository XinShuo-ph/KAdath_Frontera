	...
	do {
		...
		switch (pos_auxi(0)) {
		    ...
		    case 2 :
		      ...
		      break ;
		    default :
		      cerr << "Bad indice in Domain_polar_periodic_shell::derive_partial_spher" << endl  ;
		      abort() ;
		}
	}
	while (pos_auxi.inc()) ;
...
Term_eq Domain_polar_periodic_shell::derive_flat_spher (int type_der, char ind_der, const Term_eq& so, const Metric* manipulator) const {
	...
	do {
		...
		switch (pos_auxi_bis(0)) {
		    ...
		    case 2 :
		      ...
		      break ;
		    default :
		      cerr << "Bad indice in Domain_polar_periodic_shell::derive_flat_spher" << endl  ;
		      abort() ;
		}
	}
