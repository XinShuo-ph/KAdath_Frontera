...
void Domain_polar_shell_outer_adapted::del_deriv() {
    safe_delete(outer_radius_term_eq);
...
void Domain_polar_shell_outer_adapted::do_der_abs_from_der_var(const Val_domain *const *const der_var, Val_domain **const der_abs) const {
