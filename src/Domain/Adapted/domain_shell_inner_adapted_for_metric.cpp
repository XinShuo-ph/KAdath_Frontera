		  ...
		  switch (pos_auxi(0)) {
			...
			switch (pos_auxi(ind_sum+1)) {
			    ...
			    case 2 :
			      ...
			      break ;
			    default :
			      cerr << "Bad indice in Domain_shell_inner_adapted::derive_flat_spher" << endl  ;
			      abort() ;
			}
			break ;
		      case 2 :
...
Term_eq Domain_shell_inner_adapted::derive_flat_cart (int type_der, char ind_der, const Term_eq& so, const Metric* manipulator) const {
