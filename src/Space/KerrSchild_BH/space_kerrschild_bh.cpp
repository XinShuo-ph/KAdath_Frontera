...
#include <vector>
namespace Kadath {
Space_KerrSchild_bh::Space_KerrSchild_bh (int ttype, const Point& center, const Dim_array& res, const std::vector<double>& BH_bounds) {
...
Space_KerrSchild_bh::Space_KerrSchild_bh (FILE* fd) {
...
void Space_KerrSchild_bh::save (FILE* fd) const  {
