...
Space_polar_adapted::Space_polar_adapted (int ttype, const Point& center, const Dim_array& res, const Array<double>& bounds) {
    ...
    domains[1] = new Domain_polar_shell_outer_adapted (*this, 1, ttype, bounds(0), bounds(1), center, res) ;    
    domains[2] = new Domain_polar_shell_inner_adapted (*this, 2, ttype, bounds(1), bounds(2), center, res) ;
...
Space_polar_adapted::Space_polar_adapted (FILE* fd) {
	...
	domains[1] = new Domain_polar_shell_outer_adapted (*this, 1, fd) ;	
	domains[2] = new Domain_polar_shell_inner_adapted (*this, 2, fd) ;
	//Shells :
	for (int i=3 ; i<nbr_domains-1 ; i++)
