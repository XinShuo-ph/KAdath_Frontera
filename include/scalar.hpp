...
namespace Kadath {
	...
	*/
    ...
    public:
        ...
        /**
         * @param i : index of the desired \c Domain
    ...
    public:
        ...
        virtual void annule_hard() ; ///< Sets the value to zero everywhere in the collocation space (the logical state of the \c Val_domain is NOT zero).
    ...
    public:
        ...
        */
        ...
        friend Scalar operator+ (const Scalar&) ; ///< Operator + (unitary version)
        friend Scalar operator- (const Scalar&) ;///< Operator - (unitary version)
        friend Scalar operator+ (const Scalar&, const Scalar&) ; ///< Operator + 
        friend Scalar operator+ (const Scalar&, double) ;///< Operator + 
        friend Scalar operator+ (double, const Scalar&) ;///< Operator + 
        friend Scalar operator- (const Scalar&, const Scalar&) ;///< Operator - 
        friend Scalar operator- (const Scalar&, double) ;///< Operator - 
        friend Scalar operator- (double, const Scalar&) ;///< Operator - 
        friend Scalar operator* (const Scalar&, const Scalar&) ;///< Operator *
        ...
        friend Scalar operator/ (const Scalar&, double) ;///< Operator /
        friend Scalar operator/ (double, const Scalar&) ;///< Operator /
        friend Scalar pow (const Scalar&, int) ; ///< Operator power (integer version)
        friend Scalar pow (const Scalar&, double) ;///< Operator power (double version)
        friend Scalar sqrt (const Scalar&) ;///< Operator square root
        friend Scalar exp (const Scalar&) ;///< Operator exponential
        friend Scalar sin (const Scalar&) ;///< Operator sine
        friend Scalar cos (const Scalar&) ;///< Operator cosine
        friend double diffmax (const Scalar&, const Scalar&) ; ///< Maximal difference
