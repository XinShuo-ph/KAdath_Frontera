    ...
    */
    ...
    protected:
        ...
        */
        ...
        Memory_mapped_array<Array<double>*> coloc ; ///< Colocation points in each dimension (stored in \c ndim 1d- arrays)
        mutable Memory_mapped_array<Val_domain*> absol ; ///< Asbolute coordinates (if defined ; usually Cartesian-like)
        mutable Memory_mapped_array<Val_domain*> cart ; ///< Cartesian coordinates
        mutable Val_domain* radius ; ///< The generalized radius.
        mutable Memory_mapped_array<Val_domain*> cart_surr ; ///< Cartesian coordinates divided by the radius
        ...
        Domain(Domain && so) noexcept; ///< Move constructor.

    public:
        virtual ~Domain() {del_deriv();} ///< Destructor.
